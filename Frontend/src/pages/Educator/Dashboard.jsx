  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-full px-6 py-10 bg-gray-50 space-y-10">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left space-y-1">
            ...
            <button
              ...
              className="px-[50px] text-center py-[8px] border-2 bg-black border-black text-white
              rounded-[10px] text-[15px] font-light flex items-center justify-center cursor-pointer"
            >
              Create Courses
            </button>
          </div>
        ...
        {/*Graph section */}
        <div className='max-w-6xl mxauto grid grid-cols-1 md:grid-cols-2 gap-8'>
          ...
          {/*enrolled data */}
          <div className='bg-white rounded-lg shadow-md p-6'>
            <h2 className='text-lg font-semibold mb-4'>Students Enrollments</h2>
            <ResponsiveContainer width="100%" height={300}>
