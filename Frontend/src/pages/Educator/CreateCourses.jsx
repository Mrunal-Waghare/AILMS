      ...
      <div className='max-w-xl w-[600px] mx-auto p-6 bg-white shadow-md rounded-md mt-10 relative'>
        ...
        <form className='space-y-5' onSubmit={(e)=>e.preventDefault()}>
          <div>
            ...
            <input type="text" id='title' placeholder='Enter Curse title' 
          ...
          disabled={loading} onClick={handleCreateCourse}>{loading? <ClipLoader size={30} color="white" />:"Create Course"}</button>
        </form>
      </div>
    </div>
  )
